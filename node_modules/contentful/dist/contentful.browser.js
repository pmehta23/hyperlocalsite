var contentful = (function (exports) {
  ...
  */
  ...
  function normalizeCursorPaginationParameters(query) {
    ...
    query.cursor;
      var pagePrev = query.pagePrev,
      pageNext = query.pageNext;
      query.skip;
      var rest = __rest(query, ["cursor", "pagePrev", "pageNext", "skip"]);
  ...
  function normalizeCursorPaginationResponse(response) {
    ...
    for (var _i = 0, _Object$entries = Object.entries(Pages); _i < _Object$entries.length; _i++) {
      var _Object$entries$_i = _slicedToArray$1(_Object$entries[_i], 2),
        responseKey = _Object$entries$_i[0],
        queryKey = _Object$entries$_i[1];
      var cursorToken = extractQueryParam(queryKey, response.pages[responseKey]);
      if (cursorToken) {
  ...
  function createContentfulApi(_ref, options) {
    ...
    function getEntriesWithCursor() {
      return _getEntriesWithCursor.apply(this, arguments);
    }
    function _getEntriesWithCursor() {
      _getEntriesWithCursor = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee8() {
        var query,
          response,
          _args8 = arguments;
        return _regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              ...
              _context8.next = 3;
              return makeGetEntries(normalizeCursorPaginationParameters(query), options);
            case 3:
              response = _context8.sent;
              return _context8.abrupt("return", normalizeCursorPaginationResponse(response));
            case 5:
            case "end":
              return _context8.stop();
          }
    ...
    function _makeGetEntry() {
      _makeGetEntry = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee9(id, query) {
        var options,
          withAllLocales,
          _args9 = arguments;
        return _regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              ...
              return _context9.abrupt("return", internalGetEntry(id, withAllLocales ? Object.assign(Object.assign({}, query), {
                locale: '*'
              }) : query, options));
            case 7:
            case "end":
    ...
    function _internalGetEntry() {
      _internalGetEntry = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee10(id, query, options) {
        var response;
        return _regeneratorRuntime.wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 5:
              ...
              return _context10.abrupt("return", response.items[0]);
            case 10:
              throw notFoundError(id);
            case 11:
              _context10.next = 16;
    ...
    function _makeGetEntries() {
      _makeGetEntries = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee11(query) {
        var options,
          withAllLocales,
          _args11 = arguments;
        return _regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            case 0:
              ...
              validateRemoveUnresolvedParam(query);
              validateSearchParameters(query);
              return _context11.abrupt("return", internalGetEntries(withAllLocales ? Object.assign(Object.assign({}, query), {
                locale: '*'
              }) : query, options));
            case 7:
            case "end":
    ...
    function _getAsset() {
      _getAsset = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee13(id) {
        var query,
          _args13 = arguments;
        return _regeneratorRuntime.wrap(function _callee13$(_context13) {
          while (1) switch (_context13.prev = _context13.next) {
            case 0:
              query = _args13.length > 1 && _args13[1] !== undefined ? _args13[1] : {};
              return _context13.abrupt("return", makeGetAsset(id, query, options));
            case 2:
            case "end":
    ...
    function _getAssets() {
      _getAssets = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee14() {
        var query,
          _args14 = arguments;
        return _regeneratorRuntime.wrap(function _callee14$(_context14) {
          while (1) switch (_context14.prev = _context14.next) {
            case 0:
              ...
              return _context14.abrupt("return", makeGetAssets(query, options));
            case 2:
            case "end":
    ...
    function getAssetsWithCursor() {
      return _getAssetsWithCursor.apply(this, arguments);
    }
    function _getAssetsWithCursor() {
      _getAssetsWithCursor = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee15() {
        var query,
          response,
          _args15 = arguments;
        return _regeneratorRuntime.wrap(function _callee15$(_context15) {
          while (1) switch (_context15.prev = _context15.next) {
            ...
            case 3:
              ...
              return _context15.abrupt("return", normalizeCursorPaginationResponse(response));
            case 5:
            case "end":
    ...
    function _makeGetAssets() {
      _makeGetAssets = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee16(query) {
        var options,
          withAllLocales,
          localeSpecificQuery,
          _args16 = arguments;
    ...
    function _makeGetAsset() {
      _makeGetAsset = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee18(id, query) {
        var options,
          withAllLocales,
          localeSpecificQuery,
          _args18 = arguments;
    ...
    function _getTag() {
      _getTag = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee20(id) {
        return _regeneratorRuntime.wrap(function _callee20$(_context20) {
          while (1) switch (_context20.prev = _context20.next) {
            case 0:
              return _context20.abrupt("return", get({
                context: 'environment',
                path: "tags/".concat(id)
              }));
            case 1:
    ...
    function _getTags() {
      _getTags = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee21() {
        var query,
          _args21 = arguments;
    ...
    function _createAssetKey() {
      _createAssetKey = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee22(expiresAt) {
        ...
        return _regeneratorRuntime.wrap(function _callee22$(_context22) {
          while (1) switch (_context22.prev = _context22.next) {
            case 0:
              ...
              return _context22.abrupt("return", post({
                context: 'environment',
                path: 'asset_keys',
                data: {
                  expiresAt: expiresAt
    ...
    function _getLocales() {
      _getLocales = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee23() {
        var query,
          _args23 = arguments;
        return _regeneratorRuntime.wrap(function _callee23$(_context23) {
          while (1) switch (_context23.prev = _context23.next) {
            case 0:
              ...
              validateSearchParameters(query);
              return _context23.abrupt("return", get({
                context: 'environment',
                path: 'locales',
                config: createRequestConfig({
    ...
    function _sync() {
      _sync = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee24(query) {
        var syncOptions,
          _args24 = arguments;
        return _regeneratorRuntime.wrap(function _callee24$(_context24) {
          while (1) switch (_context24.prev = _context24.next) {
            case 0:
              syncOptions = _args24.length > 1 && _args24[1] !== undefined ? _args24[1] : {
                paginate: true
              };
              return _context24.abrupt("return", makePagedSync(query, syncOptions, options));
            case 2:
            case "end":
    ...
    function _makePagedSync() {
      _makePagedSync = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee25(query, syncOptions) {
        var options,
          combinedOptions,
          _args25 = arguments;
        return _regeneratorRuntime.wrap(function _callee25$(_context25) {
          while (1) switch (_context25.prev = _context25.next) {
            case 0:
              ...
              return _context25.abrupt("return", pagedSync(http, query, combinedOptions));
            case 6:
            case "end":
    ...
    function _internalGetConceptScheme() {
      _internalGetConceptScheme = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee26(id) {
        var query,
          _args26 = arguments;
    ...
    function _internalGetConceptSchemes() {
      _internalGetConceptSchemes = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee27() {
        var query,
          _args27 = arguments;
    ...
    function _internalGetConcept() {
      _internalGetConcept = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee28(id) {
        var query,
          _args28 = arguments;
    ...
    function _internalGetConcepts() {
      _internalGetConcepts = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee29() {
        var query,
          _args29 = arguments;
        return _regeneratorRuntime.wrap(function _callee29$(_context29) {
          while (1) switch (_context29.prev = _context29.next) {
            case 0:
              query = _args29.length > 0 && _args29[0] !== undefined ? _args29[0] : {};
              _context29.prev = 1;
    ...
    function _internalGetConceptAncestors() {
      _internalGetConceptAncestors = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee30(id) {
        var query,
          _args30 = arguments;
        return _regeneratorRuntime.wrap(function _callee30$(_context30) {
          while (1) switch (_context30.prev = _context30.next) {
            case 0:
              query = _args30.length > 1 && _args30[1] !== undefined ? _args30[1] : {};
              _context30.prev = 1;
              return _context30.abrupt("return", get({
                context: 'environment',
    ...
    function _internalGetConceptDescendants() {
      _internalGetConceptDescendants = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee31(id) {
        var query,
          _args31 = arguments;
        return _regeneratorRuntime.wrap(function _callee31$(_context31) {
          while (1) switch (_context31.prev = _context31.next) {
            case 0:
              query = _args31.length > 1 && _args31[1] !== undefined ? _args31[1] : {};
              _context31.prev = 1;
              return _context31.abrupt("return", get({
                context: 'environment',
    ...
    return {
      ...
      getAsset: getAsset,
      getAssets: getAssets,
      getAssetsWithCursor: getAssetsWithCursor,
      getTag: getTag,
      getTags: getTags,
      ...
      getEntriesWithCursor: getEntriesWithCursor,
